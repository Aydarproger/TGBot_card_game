...
@dp.message_handler(IsPrivate(), text="🎲 Чат 🎲")
async def chat(message: Message):
    await message.answer("Чат ➖ https://t.me/slivmens")

@dp.message_handler(IsPrivate(), text="🖥 Помощь")
async def help(message: Message):
    await message.answer("По всем вопросам ➖ @slivmens")


@dp.message_handler(IsPrivate(), text="💫 Отзывы 💫")
async def chat(message: Message):
    await message.answer("Отзывы ➖ https://t.me/slivmens")
